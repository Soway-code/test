...
#define CHECK_NO_ERROR                  0x00                   					// 校验结果无错误
#define CHECK_CRC_ERROR                 0x10                   					// CRC校验有错误
#define CHECK_LRC_ERROR                 0x11                   					// LRC校验有错误
...
uint16_t MDB_Get_CRC16(uint8_t *Msg, uint8_t MsgLen);							// CRC校验
