...
//	HAL_UART_Receive_IT(&huart1, UART1_RXBuff,  USART1_MAX_DATALEN);
}
...
////	{
////		UART1_SendData(UART1_RXBuff,sizeof(UART1_RXBuff));	// 接收到数据马上使用串口1发送出去
////		HAL_UART_Receive_IT(&huart1,UART1_RXBuff,USART_MAX_DATALEN);		// 重新使能串口1接收中断
////	}
//	if(huart->Instance == USART1)
//	{
////		RecvByteData = USART1->RDR;

//		MODBUS_ASCII_HandlRevData((uint8_t)UART1_RXBuff); //接收ASCII数据    
//	}
//}
