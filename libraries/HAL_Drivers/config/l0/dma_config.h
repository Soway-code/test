...
extern "C" {
#endif
//#define UART2_RX_DMA_REQUEST            DMA_REQUEST_3  //frank
...
#define UART1_RX_DMA_INSTANCE            DMA1_Channel5 //DMA1_Channel5 frank
...
#define UART2_RX_DMA_REQUEST             DMA_REQUEST_4
#define UART2_RX_DMA_IRQ                 DMA1_Channel4_5_6_7_IRQn
#endif

/* DMA1 channel2 */
#if defined(BSP_UART4_RX_USING_DMA) && !defined(UART4_RX_DMA_INSTANCE)
#define UART4_DMA_RX_IRQHandler          DMA1_Channel4_5_6_7_IRQHandler
#define UART4_RX_DMA_RCC                 RCC_AHBENR_DMA1EN
#define UART4_RX_DMA_INSTANCE            DMA1_Channel2
#define UART4_RX_DMA_IRQ                 DMA1_Channel2_3_IRQn
#endif
