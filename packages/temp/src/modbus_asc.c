...
void MBASC_Fun03(void)
{
    ...
    SendBufT[SendLenT++] = 0x03;	                        //功能码
    SendBufT[SendLenT++] = Register_Num * 2;		                        //数据长度
                                                                                //如果读取范围溢出
