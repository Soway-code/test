...
*/
#define RCC_GPIOX_CLK_1 		__HAL_RCC_GPIOB_CLK_ENABLE();		//开启GPIOx时钟
#define DS18B20_GPIOX_1 		GPIOB								//选择DS18B20 GPIOx端口
#define DS18B20_GPIO_PINX_1 	GPIO_PIN_3							//选择DS18B20 连接的管脚
